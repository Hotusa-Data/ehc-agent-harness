...
5. Follow the [Markdown Style Guide](../references/style.md) for all formatting
6. Add [Mermaid diagrams](../references/style.md) wherever a concept benefits from a visual
...
flowchart LR
    ...
    step1["Step one"] --> step2["Step two"] --> step3["Step three"]

    classDef action fill:#f8fafc,stroke:#94a3b8,stroke-width:1px,color:#0f172a
    class step1,step2,step3 action
```
