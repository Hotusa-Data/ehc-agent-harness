...
5. Add [Mermaid diagrams](../references/style.md) for any process, architecture, data flow, or comparison
...
flowchart LR
    ...
    class collect,clean,analyze,validate,report action
```
...
[Present the finding. Include a diagram if the finding involves relationships, processes, or comparisons. Bar/line/scatter charts of numeric data are NOT covered by this skill — keep the source data in a table here for reproducibility, and generate the published chart with a real charting tool.]
...
> 📊 **Figure [N].** Bar chart of the values above. Generate with your preferred charting tool (matplotlib, Seaborn, Vega-Lite, Recharts...) for the published version. The table is the canonical source.
